...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<div class="container">
			...
			<div
				...
				<ul class="nav navbar-nav">
					...
					<li><a  href="Employe">Add Employe</a></li>
	...
	<section id="about" class="container content-section text-center">
		<p>Renseignez tous les informations sur le client</p>
		<div class="row ">
				<f:form modelAttribute="modelc" action="addClient" method="post" class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-sm-2">Nom :</label>
						<div class="col-sm-4">
							<f:input type="text" path="nomClient" class="form-control" placeholder="Entrer nom"/>
						    <f:errors path="nomClient" cssClass="error"></f:errors>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2">Prenom :</label>
						<div class="col-sm-4">
							<f:input type="text" path="prenomClient" class="form-control"
								placeholder="Entrer le prenom"/>
							<f:errors path="prenomClient" cssClass="error"></f:errors>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2">Adresse :</label>
						<div class="col-sm-4">
							<f:input type="text" path="addrPosta" class="form-control"
								placeholder="Entrer l'adress"/>
							<f:errors path="addrPosta" cssClass="error"></f:errors>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2">date de naissance :</label>
						<div class="col-sm-4">
							<f:input type="date" path="dateDeNaissance" class="form-control"
								placeholder="Entrer l'adress"/>
							<f:errors path="dateDeNaissance" cssClass="error"></f:errors>
						</div>
					</div>
					<!-- button -->
				        <div class="form-group">
